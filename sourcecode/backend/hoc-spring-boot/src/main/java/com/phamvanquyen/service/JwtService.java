...
public class JwtService {
	...
	try {
	    ...
	    builder.expirationTime(gennerateExpriationDate());
    ...
    private Date gennerateExpriationDate() {
	int expire_time = Integer.parseInt(environment.getProperty("expire_time"));
